...
<p><?php printf( esc_html__( 'Notification to let you know &mdash; order #%1$s has been cancelled:', 'woocommerce' ), esc_html( $order->get_order_number() ), esc_html( $order->get_formatted_billing_full_name() ) ); ?></p>
